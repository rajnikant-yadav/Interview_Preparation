...
**Data Control Language (DCL):** DCL is used to control access to data in a database. This includes granting and revoking permissions to users and roles. DCL is typically used by database administrators.<br>
```sql
